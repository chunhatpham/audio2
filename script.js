...
window.realMoviesDatabase = [
    { title: "Chuyến Tàu Đầy Định Mệnh", img: "https://i.postimg.cc/tgmSDC8p/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Tôi Đã Quên Vị Hôn Thê", img: "https://i.postimg.cc/8CnKwPxD/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Hoa Khôi Mất Thính Lực", img: "https://i.postimg.cc/NFqGs98m/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Bạn Gái Cố Tình Làm Tôi Ghen", img: "https://i.postimg.cc/kG3MJ6NW/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Cô Gái Tôi Cứu Ép Buộc Tôi", img: "https://i.postimg.cc/13SQWBBb/27116ED2-8973-4FCD-86A9-70C61DBAFCA6.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Quay Trở Lại Nhà Mình", img: "https://i.postimg.cc/Sx4hZddv/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Xem Bói Giúp Nữ Tổng Tài", img: "https://i.postimg.cc/52JVPggK/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Anh Ấy Bỏ Tôi Mà Đi", img: "https://i.postimg.cc/sgr7QXbw/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Em Bị Vào Tròng Rồi", img: "https://i.postimg.cc/0jmKG3Fy/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Bố Tôi Trả Góp Ô Tô", img: "https://i.postimg.cc/kGz4QNmj/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Bài Kiểm Tra Của Thanh Mai", img: "https://i.postimg.cc/TwB0MTxx/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Mẹ Ra Lệnh Cho Tôi", img: "https://i.postimg.cc/bN61yP2W/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
...
window.openPlayer = function(movieName) {
    ...
    let audioLink = "";
    if (movieName.includes('Chuyến Tàu Đầy Định Mệnh')) audioLink = "https://videotourl.com/audio/1777563466161-9f448c73-e9d3-43b0-9f0b-beaddccd6771.m4a";
    else if (movieName.includes('Tôi Đã Quên Vị Hôn Thê')) audioLink = "https://videotourl.com/audio/1777563294530-0941563f-74a5-45d5-b13c-aaa9d93adb44.m4a";
    else if (movieName.includes('Hoa Khôi Mất Thính Lực')) audioLink = "https://videotourl.com/audio/1777323431832-c2b19ee8-57c8-42cb-9e79-ca841c4e67d5.m4a";
    else if (movieName.includes('Bạn Gái Cố Tình Làm Tôi Ghen')) audioLink = "https://videotourl.com/audio/1777323290605-87694d97-70a3-41cb-a6ce-c5a4d70f5d67.m4a";
    else if (movieName.includes('Cô Gái Tôi Cứu Ép Buộc Tôi')) audioLink = "https://videotourl.com/audio/1777207520610-91f0c7aa-d278-494f-8dae-59dc069061a4.m4a";
    else if (movieName.includes('Quay Trở Lại Nhà Mình')) audioLink = "https://videotourl.com/audio/1777207384337-99a13b6f-ab3e-4f35-8aa0-feeda5303f0a.m4a";
    else if (movieName.includes('Xem Bói Giúp Nữ Tổng Tài')) audioLink = "https://videotourl.com/audio/1777207234445-ae2ca984-94bc-450a-ba16-6c7b91708aab.m4a";
    else if (movieName.includes('Anh Ấy Bỏ Tôi Mà Đi')) audioLink = "https://videotourl.com/audio/1777106025510-9b2d10aa-bdd8-4899-a57e-7a2a0e3948a4.m4a";
    else if (movieName.includes('Em Bị Vào Tròng Rồi')) audioLink = "https://videotourl.com/audio/1776962266491-54fc6a82-42c4-456f-81d3-7dd8872a5cbb.m4a";
    else if (movieName.includes('Bố Tôi Trả Góp Ô Tô')) audioLink = "https://videotourl.com/audio/1776864073703-bf183d4d-5218-4cb6-9da6-aae32bdae668.m4a";
    else if (movieName.includes('Bài Kiểm Tra Của Thanh Mai')) audioLink = "https://files.catbox.moe/9g602v.m4a";
    else if (movieName.includes('Mẹ Ra Lệnh Cho Tôi')) audioLink = "https://videotourl.com/audio/1776530460630-bd9245ca-6efb-4a34-b65a-da78024d2c2a.m4a";
    else if (movieName.includes('Bố Và Mẹ Của Tôi Nhất')) audioLink = "https://videotourl.com/audio/1776432062804-f2b89215-56fc-4095-a140-b6d97124ac33.m4a";
