...
const randomRedirectLinks = [
    ...
    "https://s.shopee.vn/2BAIRarYBW",
    " https://s.shopee.vn/8fNmBaimPu",
    " https://s.shopee.vn/7VBonYSeof",
    " https://s.shopee.vn/AKW0AqBS3y",
    " https://s.shopee.vn/60N10wqrtQ",
    " https://s.shopee.vn/2BAIS1pa4v",
    " https://s.shopee.vn/2LTiePMSYk", 
    " https://s.shopee.vn/BPE4XLPyk",
    " https://s.shopee.vn/qeurpiHVH",
    " https://s.shopee.vn/4VYDEec44j",
    " https://s.shopee.vn/9AK2nH5kbH",

];

window.realMoviesDatabase = [
{
        title: "Bắt Nạt Cô Thanh Mai",
        img: "https://i.postimg.cc/bwcDLQYK/gen.jpg",
        tag: "NEW",
        desc: "Vừa ra mắt"
    },
    {
        title: "Tôi Tránh Xa Thanh Mai",
        img: "https://i.postimg.cc/90kqjPQN/proxy-img.jpg",
        tag: "NEW",
        desc: "Vừa ra mắt"
    },
    {
        title: "Đã Thật Lòng Với Em",
        img: "https://i.postimg.cc/MGwKgFzr/proxy-img.jpg",
        tag: "NEW",
        desc: "Vừa ra mắt"
    },
    {
        title: "Trợt Tỉnh Ra Sự Thật",
        img: "https://i.postimg.cc/rpgxmhPx/gen.jpg",
        tag: "NEW",
        desc: "Vừa ra mắt"
    },
    {
        title: "Lấy Hoa Khôi Lạnh Lùng",
        img: "https://i.postimg.cc/htmQfNg9/gen.jpg",
        tag: "NEW",
        desc: "Vừa ra mắt"
    },
...
if (movieName === 'Bắt Nạt Cô Thanh Mai') {
        imgSrc = 'https://i.postimg.cc/bwcDLQYK/gen.jpg';
        document.getElementById('audio-cover-img').src = imgSrc;
        document.getElementById('audio-listens-count').innerText = "17k";
        document.getElementById('audio-rating-score').innerText = "5.0";
        document.getElementById('review-overall-score').innerText = "5.0";
        window.generateCustomEpisodes(movieName, imgSrc, "1 tiếng 29 phút", "3 tiếng 36 phút", "17k");
    }
    else if (movieName === 'Tôi Tránh Xa Thanh Mai') {
        imgSrc = 'https://i.postimg.cc/90kqjPQN/proxy-img.jpg';
        document.getElementById('audio-cover-img').src = imgSrc;
        document.getElementById('audio-listens-count').innerText = "11.6k";
        document.getElementById('audio-rating-score').innerText = "5.0";
        document.getElementById('review-overall-score').innerText = "5.0";
        window.generateCustomEpisodes(movieName, imgSrc, "1 tiếng 32 phút", "2 tiếng 56 phút", "11.6k");
    } 
    else if (movieName === 'Đã Thật Lòng Với Rm') {
        imgSrc = 'https://i.postimg.cc/MGwKgFzr/proxy-img.jpg';
        document.getElementById('audio-cover-img').src = imgSrc;
        document.getElementById('audio-listens-count').innerText = "17.3k";
        document.getElementById('audio-rating-score').innerText = "5.0";
        document.getElementById('review-overall-score').innerText = "5.0";
        window.generateCustomEpisodes(movieName, imgSrc, "1 tiếng 28 phút", "3 tiếng 6 phút", "17.3k");
    } 
    else if (movieName === 'Trợt Tỉnh Ra Sự Thật') {
        imgSrc = 'https://i.postimg.cc/rpgxmhPx/gen.jpg';
        document.getElementById('audio-cover-img').src = imgSrc;
        document.getElementById('audio-listens-count').innerText = "12.3k";
        document.getElementById('audio-rating-score').innerText = "5.0";
        document.getElementById('review-overall-score').innerText = "5.0";
        window.generateCustomEpisodes(movieName, imgSrc, "1 tiếng 22 phút", "3 tiếng 21 phút", "12.3k");
    } 
    else if (movieName === 'Lấy Hoa Khôi Lạnh Lùng') {
        imgSrc = 'https://i.postimg.cc/htmQfNg9/gen.jpg';
        document.getElementById('audio-cover-img').src = imgSrc;
        document.getElementById('audio-listens-count').innerText = "27.5k";
        document.getElementById('audio-rating-score').innerText = "5.0";
        document.getElementById('review-overall-score').innerText = "5.0";
        window.generateCustomEpisodes(movieName, imgSrc, "1 tiếng 21 phút", "3 tiếng 55 phút", "27.5k");
    } 
    else if (movieName === 'Nữ Thần Liễu Như Yên') {
        ...
        document.getElementById('audio-cover-img').src = imgSrc;
        document.getElementById('audio-listens-count').innerText = "398.5k";
        document.getElementById('audio-rating-score').innerText = "5.0";
        document.getElementById('review-overall-score').innerText = "5.0";
        window.generateCustomEpisodes(movieName, imgSrc, "1 tiếng 19 phút", "4 tiếng 7 phút", "398.5k");
    } 
    else if (movieName === 'Hoàn Hảo Với Em Gái') {
        imgSrc = 'https://i.postimg.cc/PJs2GjKT/IMG-1498.jpg';
        document.getElementById('audio-cover-img').src = imgSrc;
        document.getElementById('audio-listens-count').innerText = "212.6k";
        document.getElementById('audio-rating-score').innerText = "5.0";
        document.getElementById('review-overall-score').innerText = "5.0";
        window.generateCustomEpisodes(movieName, imgSrc, "1 giờ 4 phút", "6 tiếng 55 phút", "212.6k");
    } 
...
if (movieName === 'Bắt Nạt Cô Thanh Mai ' && epName === 'SS1') {
        window.triggerRealAudio("https://files.catbox.moe/prwwla.m4a", `${epName}: ${movieName}`, img);
    }
    else if (movieName === 'Tôi Tránh Xa Thanh Mai' && epName === 'SS1') {
        window.triggerRealAudio("https://files.catbox.moe/99ni7p.m4a", `${epName}: ${movieName}`, img);
    } 
    else if (movieName === 'Đã Thật Lòng Với Rm' && epName === 'SS1') {
        window.triggerRealAudio("https://files.catbox.moe/c5da2s.m4a", `${epName}: ${movieName}`, img);
    } 
    else if (movieName === 'Trợt Tỉnh Ra Sự Thật' && epName === 'SS1') {
        window.triggerRealAudio("https://files.catbox.moe/69m56t.m4a", `${epName}: ${movieName}`, img);
    } 
    else if (movieName === 'Lấy Hoa Khôi Lạnh Lùng' && epName === 'SS1') {
        window.triggerRealAudio("https://files.catbox.moe/2v33j0.m4a", `${epName}: ${movieName}`, img);
    } 
    else if (movieName === 'Nữ Thần Liễu Như Yên' && epName === 'SS1') {
