...
window.openPlayer = function(movieName) {
    ...
    if (movieName === 'Lấy Hoa Khôi Lạnh Lùng') {
...
window.playEpisode = function(epName, movieName) {
    ...
    if (movieName === 'Lấy Hoa Khôi Lạnh Lùng' && epName === 'SS1') {
        window.triggerRealAudio("https://files.catbox.moe/f3r5g1.m4a", `${epName}: ${movieName}`, img);
    } 
